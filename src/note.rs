...
impl Note {
    ...
    fn from_value(value: isize, preferred_accidental: Accidental) -> Note {
        ...
        match (semitone, preferred_accidental) {
            (0,  _)                => Note { value: semitone as u8, letter: Letter::A, accidental: Accidental::Natural },
            (1,  Accidental::Flat) => Note { value: semitone as u8, letter: Letter::B, accidental: Accidental::Flat },
            (1,  _)                => Note { value: semitone as u8, letter: Letter::A, accidental: Accidental::Sharp },
            (2,  _)                => Note { value: semitone as u8, letter: Letter::B, accidental: Accidental::Natural },
            (3,  _)                => Note { value: semitone as u8, letter: Letter::C, accidental: Accidental::Natural },
            (4,  Accidental::Flat) => Note { value: semitone as u8, letter: Letter::D, accidental: Accidental::Flat },
            (4,  _)                => Note { value: semitone as u8, letter: Letter::C, accidental: Accidental::Sharp },
            (5,  _)                => Note { value: semitone as u8, letter: Letter::D, accidental: Accidental::Natural },
            (6,  Accidental::Flat) => Note { value: semitone as u8, letter: Letter::E, accidental: Accidental::Flat },
            (6,  _)                => Note { value: semitone as u8, letter: Letter::D, accidental: Accidental::Sharp },
            (7,  _)                => Note { value: semitone as u8, letter: Letter::E, accidental: Accidental::Natural },
            (8,  _)                => Note { value: semitone as u8, letter: Letter::F, accidental: Accidental::Natural },
            (9,  Accidental::Flat) => Note { value: semitone as u8, letter: Letter::G, accidental: Accidental::Flat },
            (9,  _)                => Note { value: semitone as u8, letter: Letter::F, accidental: Accidental::Sharp },
            (10, _)                => Note { value: semitone as u8, letter: Letter::G, accidental: Accidental::Natural },
            (11, Accidental::Flat) => Note { value: semitone as u8, letter: Letter::A, accidental: Accidental::Flat },
            (11, _)                => Note { value: semitone as u8, letter: Letter::G, accidental: Accidental::Sharp },
            _                      => unreachable!()
        }
    }
}
